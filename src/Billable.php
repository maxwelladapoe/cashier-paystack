...
namespace MaxwellAdapoe\CashierPaystack;
...
trait Billable
{
     ...
     * @param  string  $plan
     * @return \MaxwellAdapoe\CashierPaystack\SubscriptionBuilder
     */
     ...
     *
     * @param  string  $id
     * @return \MaxwellAdapoe\CashierPaystack\Invoice|null
     */
     ...
     *
     * @param  string  $id
     * @return \MaxwellAdapoe\CashierPaystack\Invoice
     */
