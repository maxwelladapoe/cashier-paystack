...
namespace MaxwellAdapoe\CashierPaystack\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Support\Carbon;
use Illuminate\Routing\Controller;
use MaxwellAdapoe\CashierPaystack\Cashier;
use MaxwellAdapoe\CashierPaystack\Subscription;
use Symfony\Component\HttpFoundation\Response;
use MaxwellAdapoe\CashierPaystack\Http\Middleware\VerifyWebhookSignature;
...
class WebhookController extends Controller
{
     ...
     *
     * @param  string  $subscriptionCode
     * @return \MaxwellAdapoe\CashierPaystack\Subscription|null
     */
     ...
     * @return \MaxwellAdapoe\CashierPaystack\Billable
     */
